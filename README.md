...
The benefit of a Split Tunnel VPN is that you can still interact with devices on your Local Network (such as Chromecast) with encrypted DNS based ad-blocking.
